      ...
      <main className="relative min-h-[calc(100vh-64px)] flex flex-col items-center justify-center p-4">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-20 pointer-events-none">
          {Array.from({ length: 50 }).map((_, i) => (
            ...
            >
              {`const ${
                ["soora", "soora", "soora", "soora"][i % 4]
              } = ${Math.random().toString(36).substring(7)};`.repeat(14)}
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 z-10 ">
          ...
          <button
            ...
            className="bg-transparent border border-blue-400 text-blue-400 px-6 py-2 rounded hover:bg-blue-400 hover:text-gray-900 transition-colors"
          >
            Sign In
          </button>
          <div className="relative sm:col-span-2">
            <button
              ...
              className="w-full bg-transparent border border-blue-400 text-blue-400 px-6 py-2 rounded hover:bg-transparent hover:text-blue-300 transition-colors"
            >
              Getting Started
            </button>
            <svg
