            ...
            {[
              {
                ...
                description:
                  "Seamlessly integrate our powerful APIs into your applications.",
              },
              {
              ...
              },
              {
                title: "Consulting",
                description:
                  "Expert advice to optimize your development processes.",
              },
              {
                title: "Support",
                description:
              ...
              <div
                key={service.title}
                className="bg-transparent border-2 border-white p-6 rounded-lg shadow-lg"
              >
